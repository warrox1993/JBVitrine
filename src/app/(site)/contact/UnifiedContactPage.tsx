...
const QuoteWizard = dynamic(
  () => import('@/components/features/contact/QuoteWizard/QuoteWizard').then((mod) => mod.QuoteWizard),
  {
...
import { SimpleContactForm, ContactFormData } from '@/components/features/contact/SimpleContactForm';
import { ContactModeSelector, ContactMode } from '@/components/features/contact/ContactModeSelector';
import { Accordion } from '@/components/features/contact/Accordion';
  ...
  return (
    <>
      ...
      <SectionWithBackground className={cls.serviceArea} variant="light">
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d2530.0567398516864!2d5.56387597702214!3d50.644637371630104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNTDCsDM4JzQwLjciTiA1wrAzMyc1OS4yIkU!5e0!3m2!1sfr!2sbe!4v1767805546542!5m2!1sfr!2sbe"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
