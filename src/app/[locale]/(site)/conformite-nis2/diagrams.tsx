...
export async function FunctionsRing() {
  ...
  return (
    ...
    >
      ...
      {/* center hub */}
      <circle cx="260" cy="215" r="58" fill="#0c1a16" />
      <text
        x="260"
        y="209"
        textAnchor="middle"
      ...
      <rect x="248" y="234" width="24" height="2.4" rx="1.2" fill="#0b7a5b" />
      {/* nodes */}
      <g fontFamily={SANS} textAnchor="middle">
        {/* Govern (accent) */}
        <circle cx="260" cy="75" r="34" fill="#ffffff" stroke="#0b7a5b" strokeWidth="2.2" />
        <text x="260" y="70" fontFamily={MONO} fontSize="9" fontWeight="700" fill="#657189">
          01
        </text>
        <text x="260" y="85" fontSize="12.5" fontWeight="700" fill="#0c1a16">
          Govern
        </text>
        {/* Identify */}
        <circle cx="381" cy="145" r="34" fill="#ffffff" stroke="#1e3a32" strokeWidth="1.8" />
        <text x="381" y="140" fontFamily={MONO} fontSize="9" fontWeight="700" fill="#657189">
          02
        </text>
        <text x="381" y="155" fontSize="12" fontWeight="700" fill="#0c1a16">
          Identify
        </text>
        {/* Protect */}
        <circle cx="381" cy="285" r="34" fill="#ffffff" stroke="#1e3a32" strokeWidth="1.8" />
        <text x="381" y="280" fontFamily={MONO} fontSize="9" fontWeight="700" fill="#657189">
          03
        </text>
        <text x="381" y="295" fontSize="12" fontWeight="700" fill="#0c1a16">
          Protect
        </text>
        {/* Detect */}
        <circle cx="260" cy="355" r="34" fill="#ffffff" stroke="#1e3a32" strokeWidth="1.8" />
        <text x="260" y="350" fontFamily={MONO} fontSize="9" fontWeight="700" fill="#657189">
          04
        </text>
        <text x="260" y="365" fontSize="12" fontWeight="700" fill="#0c1a16">
          Detect
        </text>
        {/* Respond */}
        <circle cx="139" cy="285" r="34" fill="#ffffff" stroke="#1e3a32" strokeWidth="1.8" />
        <text x="139" y="280" fontFamily={MONO} fontSize="9" fontWeight="700" fill="#657189">
          05
        </text>
        <text x="139" y="295" fontSize="12" fontWeight="700" fill="#0c1a16">
          Respond
        </text>
        {/* Recover */}
        <circle cx="139" cy="145" r="34" fill="#ffffff" stroke="#1e3a32" strokeWidth="1.8" />
        <text x="139" y="140" fontFamily={MONO} fontSize="9" fontWeight="700" fill="#657189">
          06
        </text>
        <text x="139" y="155" fontSize="12" fontWeight="700" fill="#0c1a16">
          Recover
        </text>
      </g>
    </svg>
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx="140" cy="96" r="3.5" fill="#1e3a32" />
      <circle cx="330" cy="73" r="3.5" fill="#0b7a5b" />
      <circle cx="520" cy="64" r="3.5" fill="#13251f" />
      {/* bars */}
      <rect x="80" y="96" width="120" height="156" rx="7" fill="#eef2f7" stroke="#1e3a32" strokeWidth="1.5" />
      <rect x="270" y="73" width="120" height="179" rx="7" fill="#d6f0e5" stroke="#0b7a5b" strokeWidth="2" />
      <rect x="460" y="64" width="120" height="188" rx="7" fill="#13251f" stroke="#13251f" strokeWidth="1.5" />
      {/* coverage values */}
      <text x="140" y="120" textAnchor="middle" fontSize="13" fontWeight="800" fill="#1e3a32" letterSpacing="-.01em">
        {t("diagram.covBasic")}
      </text>
      ...
      {/* names */}
      <text x="140" y="279" textAnchor="middle" fontSize="15" fontWeight="700" fill="#0c1a16">
        Basic
      </text>
      <text x="330" y="279" textAnchor="middle" fontSize="15" fontWeight="700" fill="#0c1a16">
        Important
      </text>
      ...
      <text x="520" y="279" textAnchor="middle" fontSize="15" fontWeight="700" fill="#0c1a16">
        Essential
      </text>
      {/* level dots */}
      <g>
        <circle cx="129" cy="306" r="3.6" fill="#1e3a32" />
        <circle cx="140" cy="306" r="3.6" fill="#d3dae6" />
        <circle cx="151" cy="306" r="3.6" fill="#d3dae6" />
        <circle cx="319" cy="311" r="3.6" fill="#0b7a5b" />
        <circle cx="330" cy="311" r="3.6" fill="#0b7a5b" />
        <circle cx="341" cy="311" r="3.6" fill="#d3dae6" />
        <circle cx="509" cy="306" r="3.6" fill="#13251f" />
        <circle cx="520" cy="306" r="3.6" fill="#13251f" />
        <circle cx="531" cy="306" r="3.6" fill="#13251f" />
      </g>
    </svg>
  );
}
...
export async function Roadmap() {
  ...
  return (
    ...
    >
      ...
      <path d="M463 52 H630" stroke="#0b7a5b" strokeWidth="2" strokeLinecap="round" strokeDasharray="1 0" />
      {/* milestones */}
      <g textAnchor="middle">
        {/* 1 */}
        <circle cx="90" cy="52" r="22" fill="#0c1a16" />
        <text x="90" y="58" fontSize="16" fontWeight="700" fill="#ffffff" fontFamily={MONO}>
          1
        </text>
        <text x="90" y="96" fontSize="12.5" fontWeight="700" fill="#0c1a16">
        ...
        {/* 2 */}
        <circle cx="277" cy="52" r="22" fill="#0c1a16" />
        <text x="277" y="58" fontSize="16" fontWeight="700" fill="#ffffff" fontFamily={MONO}>
          2
        </text>
        <text x="277" y="96" fontSize="12.5" fontWeight="700" fill="#0c1a16">
        ...
        {/* 3 */}
        <circle cx="463" cy="52" r="22" fill="#0c1a16" />
        <text x="463" y="58" fontSize="16" fontWeight="700" fill="#ffffff" fontFamily={MONO}>
          3
        </text>
        <text x="463" y="96" fontSize="12.5" fontWeight="700" fill="#0c1a16">
        ...
        {/* 4 (goal) */}
        <circle cx="630" cy="52" r="22" fill="#0b7a5b" />
        <path
          ...
          strokeLinejoin="round"
        />
        <text x="630" y="96" fontSize="12.5" fontWeight="700" fill="#0c1a16">
