...
export async function RoadmapIllustration() {
  ...
  return (
    <svg viewBox="0 0 1160 232" fill="none" aria-hidden="true">
      ...
      />
      <g transform="translate(119,149)" stroke="#0c1a16" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="11" cy="11" r="7" />
        <path d="m21 21-4.3-4.3" />
      </g>
      <text x="130" y="218" textAnchor="middle" fontFamily="system-ui,-apple-system,Segoe UI,Roboto,sans-serif" fontSize="14.5" fontWeight="700" fill="#0c1a16">
        {t("diagnostic")}
      </text>
      ...
      <circle
        ...
        style={{ filter: "drop-shadow(0 6px 10px rgba(11,31,58,.16))" }}
      />
      <g transform="translate(419,113)" stroke="#0c1a16" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 4h18M3 11h13M3 18h8" />
      </g>
      <text x="430" y="182" textAnchor="middle" fontFamily="system-ui,-apple-system,Segoe UI,Roboto,sans-serif" fontSize="14.5" fontWeight="700" fill="#0c1a16">
        {t("priorisation")}
      </text>
      ...
      <circle
        ...
        style={{ filter: "drop-shadow(0 6px 10px rgba(11,31,58,.16))" }}
      />
      <g transform="translate(719,77)" stroke="#0c1a16" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14.7 6.3a4 4 0 0 0-5.4 5.4l-6 6a2 2 0 0 0 2.8 2.8l6-6a4 4 0 0 0 5.4-5.4l-2.5 2.5-2.3-.5-.5-2.3 2.5-2.5Z" />
      </g>
      <text x="730" y="146" textAnchor="middle" fontFamily="system-ui,-apple-system,Segoe UI,Roboto,sans-serif" fontSize="14.5" fontWeight="700" fill="#0c1a16">
        {t("remediation")}
      </text>
      ...
      <circle
        ...
        stroke="#0b7a5b"
        strokeWidth="2"
        style={{ filter: "drop-shadow(0 8px 14px rgba(11, 122, 91, .35))" }}
      />
      <g transform="translate(1019,41)" stroke="#ffffff" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8Z" />
        <circle cx="12" cy="12" r="3" />
      </g>
      <text x="1030" y="110" textAnchor="middle" fontFamily="system-ui,-apple-system,Segoe UI,Roboto,sans-serif" fontSize="14.5" fontWeight="700" fill="#0c1a16">
        {t("supervision")}
      </text>
    </svg>
  );
...
export function ProofVisual() {
  return (
    <svg viewBox="0 0 560 232" fill="none" aria-hidden="true">
      ...
      <g>
        <rect x="40" y="130" width="18" height="18" rx="5" fill="#0c1a16" />
      ...
      <g>
        <rect x="40" y="162" width="18" height="18" rx="5" fill="#0c1a16" />
      ...
      <circle cx="482" cy="188" r="30" fill="#ffffff" stroke="#0b7a5b" strokeWidth="2.5" />
      <circle cx="482" cy="188" r="23" fill="none" stroke="#0b7a5b" strokeWidth="1.2" strokeDasharray="3 4" opacity=".65" />
...
export function AiIllustration() {
  return (
    <svg viewBox="0 0 900 250" fill="none" aria-hidden="true">
      ...
      <circle cx="295" cy="140" r="3" fill="#34d399" />
      <circle cx="345" cy="140" r="3" fill="#34d399" opacity=".6" />

      {/* Shared shield (verified outcome) */}
      <g transform="translate(420,104)">
        <path d="M30 4 6 12v18c0 22 14 34 24 40 10-6 24-18 24-40V12L30 4Z" stroke="#34d399" strokeWidth="2" fill="rgba(11, 122, 91, .12)" strokeLinejoin="round" />
        <path d="M20 32l7 7 13-15" stroke="#34d399" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      ...
      <circle cx="555" cy="140" r="3" fill="#34d399" opacity=".6" />
      <circle cx="605" cy="140" r="3" fill="#34d399" />
