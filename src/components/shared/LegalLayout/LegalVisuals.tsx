...
export function MentionsVisual() {
  return (
    <svg viewBox="0 0 140 140" fill="none" focusable="false">
      ...
      <circle cx="30" cy="76" r="3.5" fill="#0b7a5b" />
      ...
      />
      <path d="M85 96l8 8 16-18" stroke="#1e3a32" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function PrivacyVisual() {
  return (
    <svg viewBox="0 0 140 140" fill="none" focusable="false">
      ...
      <circle cx="32" cy="42" r="3.2" fill="#1e3a32" />
      <circle cx="108" cy="38" r="3.2" fill="#1e3a32" />
      <circle cx="110" cy="100" r="3.2" fill="#1e3a32" />
      <circle cx="30" cy="102" r="3.2" fill="#1e3a32" />
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="48" y="60" width="44" height="36" rx="8" fill="#fff" stroke="#0c1a16" strokeWidth="2.4" />
      <path d="M56 60v-13a14 14 0 0 1 28 0v13" fill="none" stroke="#0c1a16" strokeWidth="2.4" strokeLinecap="round" />
      <circle cx="70" cy="78" r="4.5" fill="#0b7a5b" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 140 140" fill="none" focusable="false">
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M83 84l7 7 14-15" stroke="#1e3a32" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
