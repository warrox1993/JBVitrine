    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (recentSubmissions.length >= maxSubmissions) {
                setGlobalError('Vous avez atteint la limite de soumissions. Veuillez réessayer dans une heure ou nous contacter directement à contact.smidjan@outlook.com.');
                setStatus('error');
                return;
            }
        ...
        try {
            ...
            setStatus('error');
            setGlobalError(error instanceof Error ? error.message : 'Un souci est survenu. Réessayez dans quelques minutes, ou écrivez-nous à contact.smidjan@outlook.com.');
        }
    };
