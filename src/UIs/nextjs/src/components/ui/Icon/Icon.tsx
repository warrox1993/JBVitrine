...
/**
 * Icon — inline Lucide-style stroke SVG set (24×24, currentColor).
 * No icon font / external library. Add new glyphs to ICON_PATHS.
 * Ported from the approved Smidjan mockups.
 */
...
/** Raw inner markup for each glyph (drawn on a 0 0 24 24 canvas). */
const ICON_PATHS: Record<IconName, React.ReactNode> = {
  ...
  server: (
    <>
      ...
      <path d="M8 21h8M12 17v4M6 8h.01M10 8h4" />
    </>
  ),
  users: (
    <>
