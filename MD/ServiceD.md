    ...
    <section class="cta-section" style="margin-top: 80px;">
        <div class="container">
            ...
            <div class="cta-buttons" style="justify-content: center; margin-top: 30px;">
                ...
                <a href="mailto:contact.smidjan@outlook.com" class="btn btn-white" style="background: transparent; border: 2px solid #fff;">Envoyer un email</a>
            </div>
        </div>
    </section>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; margin-bottom: 40px;">
                ...
                <div>
                    ...
                    <p style="color: #b0b0b0; line-height: 2;">
                        Email: contact.smidjan@outlook.com<br>
